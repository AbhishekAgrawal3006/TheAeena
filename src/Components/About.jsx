...
import { MDBContainer as Container, MDBRow as Row, MDBCol as Col, MDBIcon as Fa, MDBRipple as View} from 'mdb-react-ui-kit';
                ...
                <Row className="border-bottom">
                    <Col lg="5">
                        <View className="rounded z-depth-4 mb-lg-0 mb-4 " hover waves>
                            <img className="img-fluid" src="https://cdn.pixabay.com/photo/2021/08/25/20/42/field-6574455__340.jpg" alt="Sample image" />
